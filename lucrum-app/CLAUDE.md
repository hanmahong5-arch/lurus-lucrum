...
React Native (Expo SDK 52) Android app for the Lucrum AI Quantitative Trading Platform.
...
- **Shared Types**: `../shared/types/` (shared with lucrum-web)

## Design System

Dark mode only. Mirrors `lucrum-web/docs/DESIGN_SYSTEM.md`.
...
- All API calls go through lucrum-web API routes or lurus-api. No direct DB access.
