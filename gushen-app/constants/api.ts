 ...
 * API Configuration
 *
 * All API calls go through gushen-web API Routes or lurus-api.
 * The mobile app never directly connects to databases.
 */

export const API_CONFIG = {
  // gushen-web API base (Next.js API routes)
  GUSHEN_API_URL: "https://gushen.lurus.cn/api",
...
/**
 * API endpoint paths (relative to GUSHEN_API_URL)
 */
