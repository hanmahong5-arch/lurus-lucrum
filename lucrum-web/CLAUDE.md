...
```bash
# Database
DATABASE_URL=postgresql://user:pass@host:5432/lucrum
...
- **Worker**: `cloud-ubuntu-3` (100.113.79.77) - Runs `lucrum-web` pods
- **Messaging**: `office-debian-2` (100.120.110.73) - NATS, Redis

**Operations**:

- **Logs**: `kubectl logs -n lucrum -l app=lucrum-web`
- **Restart**: `kubectl rollout restart deployment/lucrum-web -n lucrum`
...
Subsystem of **lurus-lucrum**. BMAD artifacts in parent service dir.
