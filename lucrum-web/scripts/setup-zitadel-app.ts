 ...
 *
 * Automates creation of the Lucrum Web application in Zitadel console.
...
async function run() {
  ...
  try {
    ...
    console.log("[4/6] Creating Lucrum Web application...");
    ...
    console.log("\nNext step: restart lucrum-web dev server");
