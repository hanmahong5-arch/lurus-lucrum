 ...
 *
 * Authentication for Lucrum platform via Zitadel OIDC.
 ...
 * they are managed by lurus-platform and must be fetched via the internal API:
 *   GET /internal/v1/accounts/:id/entitlements/lurus-lucrum
 ...
 * checks must call lurus-platform directly.
 */
function extractZitadelRole(
  ...
  // Use lurus-platform GET /internal/v1/accounts/:id/entitlements/lurus-lucrum
...
export const authOptions: NextAuthOptions = {
  ...
  secret: process.env.NEXTAUTH_SECRET || "lucrum-secret-key-change-in-production",
